    ...
    return (
        <Modal show={show} onHide={onClose} backdrop="static" centered size="lg">
            <Modal.Header closeButton>
                <Modal.Title>
                    {initialData ? (
                        <><FaEdit className="me-2 text-primary" /> Sửa biến thể</>
                    ) : (
                        <><FaPlus className="me-2 text-success" /> Thêm biến thể</>
                    )}
                </Modal.Title>
            </Modal.Header>
            <Modal.Body>
                {loading ? (
                    ...
                    <Form onSubmit={handleSubmit} encType="multipart/form-data">
                        <Row className="mb-3">
                            <Col md={6}>
                                <Form.Label className="fw-bold">Sản phẩm</Form.Label>
                            ...
                            <Col md={3}>
                                ...
                                <Form.Select name="SizeID" value={form.SizeID} onChange={handleChange} required>
                            ...
                            <Col md={3}>
                                ...
                                <Form.Select name="ColorID" value={form.ColorID} onChange={handleChange} required>
                        ...
                        <Row className="mb-3">
                            ...
                            <Col md={6}>
                                <Form.Label className="fw-bold">Tồn kho</Form.Label>
                                <Form.Control
                                    type="number"
                                    name="StockQuantity"
                        ...
                        <Row className="mb-3">
                            <Col>
                                <Form.Label className="fw-bold">Ảnh biến thể</Form.Label>
                                <Form.Control type="file" accept="image/*" onChange={handleFileChange} />
                                {existingImage && (
                                    <div className="mt-2">
                                        <small>Ảnh hiện tại:</small>
                                        <div><img src={existingImage} alt="preview" width="100" className="rounded border" /></div>
                                    </div>
                                )}
                            </Col>
                        </Row>
