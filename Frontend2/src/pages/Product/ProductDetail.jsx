...
const ProductDetail = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        ...
        // Added: Log to debug API data in responsive mode
  ...
  useEffect(() => {
    if (selectedSize && selectedColor && variants.length > 0) {
      ...
      // Added: Log to debug variant selection
  ...
  const isStockLimitReached = useCallback(() => {
    ...
    return currentQuantity >= selectedVariant.StockQuantity;
  ...
  const handleAddToCart = useCallback(async () => {
    if (isAdding || isStockLimitReached()) return;
    setIsAdding(true);
  ...
  const SkeletonLoader = () => (
    <div className="row g-4">
      <div className="col-md-7 col-12">
        {" "}
        {/* Modified: Added col-12 for responsive */}
        <div
          className="skeleton"
          style={{ maxHeight: "500px", width: "100%", borderRadius: "12px" }}
        />
          ...
          <div className="col-md-7 col-12">
            ...
            <div className="position-relative">
              ...
              >
                <div className="carousel-inner">
                  <div className="carousel-item active">
                    <img
                      ...
                      className="d-block w-100 rounded-3 shadow product-image img-fluid" // Modified: Added img-fluid
                      style={{
                        maxHeight: "500px",
                        width: "100%",
                        objectFit: "contain"
                ...
                {/* Modified: Hide carousel controls if only one image */}
                {variants.filter((v) => v.ImageURL).length > 1 && (
                  <>
                    <button
            ...
            <div className="p-4 bg-white rounded-3 shadow">
              ...
              {selectedVariant && (
                <p className="text-muted fs-5 mb-4">
                  Price: {selectedVariant.Price.toLocaleString("en-US")} $
                </p>
              )}
              ...
              <div className="mb-3">
                ...
                <select
                  className="form-select form-select-sm" // Modified: Added form-select-sm
                  value={selectedSize}
              ...
              <div className="mb-4">
                ...
                <div className="input-group">
                  {" "}
                  {/* Modified: Removed w-50 */}
                  <button
                    className="btn btn-outline-secondary"
                    onClick={decreaseQuantity}
                    disabled={
                      quantity <= 1 || !selectedVariant || isStockLimitReached()
                    }
              ...
              {/* Add to Cart and Buy Now Buttons or Stock Limit Message */}
              <div className="mb-4">
                {isStockLimitReached() ? (
                  <div className="stock-limit-message">
                    Product has reached stock limit!
                  </div>
                ) : (
                  <div className="d-flex gap-2 flex-column flex-sm-row">
                    {" "}
                    {/* Modified: Added flex-column for small screens */}
                    <button
